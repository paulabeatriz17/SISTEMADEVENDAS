...
public class JDlgUsuariosNovoIA extends javax.swing.JDialog {
    ...
    public UsuarioPbt viewBean() {
        UsuarioPbt usuarios = new UsuarioPbt();
        usuarios.setIdusuarioPbt(Util.strInt(jTxtCodigo.getText()));
        ...
        usuarios.setNivelPbt(Util.strInt(jCboNivel.getActionCommand()));
    ...
    public UsuarioPbt beanView() {
        ...
        jPwfSenha.setText(usuarios.getSenhaPbt());
    ...
    private void jBtnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnOkActionPerformed
        // TODO add your handling code here:
        UsuarioPbt usuarios = viewBean();
        UsuarioPbt_DAO usuarioDAO = new UsuarioPbt_DAO();
